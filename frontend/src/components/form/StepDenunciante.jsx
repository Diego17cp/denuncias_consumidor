					...
					{documentOptions.map((option) => (
						<motion.button
							...
							className={`
                                ...
                                transition-all ${
									tipoDocumento === option.value && !anonimo
								...
								>
									...
									<div className="relative">
										<input
											...
											onChange={handleDenuncianteDigits(
												"dni",
												8
											)}
											inputMode="numeric"
					...
					<div>
						...
						>
							...
							<div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
								{/* Opción Masculino */}
								<div
									className={`relative rounded-xl p-4 border-2 cursor-pointer transition-all duration-300 ${
										denunciante.sexo === "M"
