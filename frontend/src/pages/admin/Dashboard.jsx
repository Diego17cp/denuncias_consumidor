							...
							>
								...
								<div className="relative p-6">
									<div className="flex items-center justify-between mb-4">
										<div
											className={`p-3 rounded-xl bg-gradient-to-r ${module.gradient} shadow-lg group-hover:scale-110 transition-transform duration-300`}
										>
									...
									<div className="flex items-center justify-between">
										<div
											className={`inline-flex items-center text-sm font-medium bg-gradient-to-r ${module.gradient} bg-clip-text text-transparent group-hover:scale-105 transition-transform`}
										>
											Acceder al módulo
											<svg
